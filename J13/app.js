...
function f7() {
    let isWas = false;
    for (let key in a7) {
        if (document.querySelector(".i-7").value == key) {
            document.querySelector(".out-7").innerHTML = a7[key];
            isWas = true;
            break;
        }
    }
...
function f9() {
    let out = "";
    for (let key in a9) {
        if ((+document.querySelector(".i-9").value) == a9[key]) {
            out += key + " ";
        }
    }
...
function f11() {
    for (let key in a11) {
        if (document.querySelector(".i-11").value == a11[key]) {
            delete a11[key];
        }
    }
    f5(a11, ".out-11");
