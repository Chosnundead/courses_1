...
function f2() {
    ...
    document.querySelector('.out-1').innerHTML = a2[0][1];
    return a2[0][1];
    // return
}
...
function f3() {
    ...
    document.querySelector('.out-1').innerHTML = a3[2][1][1];
    return a3[2][1];
    // return
}
...
function f4() {
    ...
    document.querySelector('.out-1').innerHTML = a4[1];
    return a4[1];
    // return
}
