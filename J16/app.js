...
function f3() {
    for (let item of document.querySelectorAll("div.out-3")) {
        item.innerHTML = 3;
    }
}
...
function f4() {
    for (let item of document.querySelectorAll("div.out-4")) {
        item.innerHTML += 4;
    }
}
...
function f6() {
    ...
    for (let i = 0; i < newArr.length; i++) {
        document.querySelector("div.out-6").innerHTML += newArr[i] + " ";
    }
}
...
function f9() {
    maxNumber = 0;
    for (let item of a9) {
        if (maxNumber < (item.length - 1)) {
            maxNumber = (item.length - 1);
        }
    }
    return maxNumber;
}
...
function f15() {
    for (let item of document.querySelectorAll(".out-15")) {
        item.innerHTML = 15;
    }
}
